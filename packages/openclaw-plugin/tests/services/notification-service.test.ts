...
import { createNotificationService, type NotificationServiceConfig, type NotificationServiceEvents } from '../../src/services/notification-service.js';
...
describe('Notification Service', () => {
  ...
  describe('Service Lifecycle', () => {
    it('should start service and begin polling', async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(expect.stringContaining('Starting notification service'), expect.anything());
    });
    ...
    it('should stop service cleanly', async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(expect.stringContaining('Notification service stopped'), expect.anything());
    });
    ...
    it('should not start if disabled', async () => {
      ...
      expect(mockLogger.debug).toHaveBeenCalledWith(expect.stringContaining('Notification service disabled'), expect.anything());
    });
  });
  ...
  describe('Polling Behavior', () => {
    ...
    it('should handle poll errors gracefully', async () => {
      (mockApiClient.get as ReturnType<typeof vi.fn>).mockRejectedValue(new Error('Network error'));
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining('poll failed'), expect.anything());
    });
  });
  ...
  describe('Event Mapping', () => {
    ...
    for (const { event, expectedEmit } of testCases) {
      it(`should map ${event} to ${expectedEmit}`, async () => {
        ...
        expect(mockEmitter.emit).toHaveBeenCalledWith(expectedEmit, expect.anything());
      });
    }
  });
  ...
  describe('Service State', () => {
    ...
    it('should not start if already running', async () => {
      ...
      expect(mockLogger.debug).toHaveBeenCalledWith(expect.stringContaining('already running'), expect.anything());
    });
