...
describe('Config Schema', () => {
  ...
  describe('resolveConfigSecrets', () => {
    ...
    it('should use configured command timeout', async () => {
      ...
      expect(childProcess.execSync).toHaveBeenCalledWith('echo test-key', expect.objectContaining({ timeout: 10000 }));
    });
  });
  ...
  describe('resolveConfigSecretsSync', () => {
    ...
    it('should propagate execSync timeout errors', () => {
      ...
      expect(() => resolveConfigSecretsSync(rawConfig)).toThrow(/timed out/);
    });
    ...
    it('should propagate readFileSync failure errors', () => {
      ...
      expect(() => resolveConfigSecretsSync(rawConfig)).toThrow(/Failed to read secret file/);
    });
