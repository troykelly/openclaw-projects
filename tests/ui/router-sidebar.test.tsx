...
describe('RouterSidebar', () => {
  ...
  it('renders all default navigation items as links', () => {
    ...
    // 16 main nav items: Activity, Projects, People, Memory, Notes, Communications, Recipes, Meal Log, Home Automation, Pantry, Voice, Symphony, Terminal, Dev Sessions, Dev Prompts, Skill Store
