...
-- 1. Drop user_email columns from entity tables
...
-- 2. Drop user_email indexes (IF EXISTS for safety)
...
-- 3. Deprecation comments on sharing tables (replaced by namespace grants)
