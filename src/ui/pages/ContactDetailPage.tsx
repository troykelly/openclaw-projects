...
import { ArrowLeft, Bell, Calendar, Clock, FileText, Globe, Link2, Mail, MessageSquare, Pencil, Phone, Trash2, Users } from 'lucide-react';
...
import type { CommChannel, Contact, ContactBody, CustomField } from '@/ui/lib/api-types';
...
export function ContactDetailPage(): React.JSX.Element {
  ...
  // Fetch contact with relationships included
  const { data: contact, isLoading, isError, error, refetch } = useContactDetail(contact_id ?? '', 'endpoints,relationships');
    ...
    <div data-testid="page-contact-detail" className="p-6 h-full flex flex-col">
      ...
      <Tabs defaultValue="endpoints" className="flex-1">
        ...
        <TabsContent value="custom-fields" className="mt-4" data-testid="custom-fields-tab">
          <CustomFieldsSection fields={customFields} onSave={handleSaveCustomFields} isSubmitting={isSubmitting} />
        </TabsContent>
