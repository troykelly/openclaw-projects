/**
 * Namespace picker for entity creation forms (Issue #1482, #2357).
 *
 ...
 */
export function NamespacePicker({ value, onValueChange, label = NAMESPACE_STRINGS.picker.label, className }: NamespacePickerProps): React.JSX.Element | null {
  ...
  return (
    <div className={className} data-testid="namespace-picker">
      ...
      <Select value={currentValue} onValueChange={onValueChange}>
        <SelectTrigger id="namespace-picker" className="mt-2 w-full" aria-label={NAMESPACE_STRINGS.picker.ariaLabel}>
